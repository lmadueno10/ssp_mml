...
public class ReportadosPorMiAdapter extends RecyclerView.Adapter<ReportadosPorMiAdapter.ReportadosPorMiAdapterHolder>{
    private List<Incidente> incidentes;
    public ReportadosPorMiAdapter(){
        if(incidentes==null){
    ...
    @NonNull
    @Override
    public ReportadosPorMiAdapter.ReportadosPorMiAdapterHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_asignados_response, parent, false);

        return new ReportadosPorMiAdapter.ReportadosPorMiAdapterHolder(view);
    }


    @Override
    public void onBindViewHolder(@NonNull ReportadosPorMiAdapter.ReportadosPorMiAdapterHolder holder, int position) {
    ...
    public static class ReportadosPorMiAdapterHolder extends RecyclerView.ViewHolder {
        ...
        public ReportadosPorMiAdapterHolder(@NonNull View itemView) {
            super(itemView);
